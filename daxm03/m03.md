...
|***NF1.1 Programació estructurada*** | ***25*** | ***20*** |
...
|***NF1.2 Estructures de dades*** | ***49*** | ***42*** |
...
|*A1.2.4 Estructures complexes* | *15* | *10* |
...
|***NF4.1 Classes i objectes*** | ***12*** | ***8*** |
|*A4.1.1 Classes, objectes i encapsulació* | *7* | *4* |
|*A4.1.2 Programació amb objectes* | *5* | *4* |
|***NF4.2 Herència i polimorfisme*** | ***23*** | ***15*** |
|*A4.2.1 Herència* | *12* | *8* |
|*A4.2.2 Polimorfisme* | *11* | *7* |
|**UF5. POO. Biblioteques de classes fonamentals** |    **35** |   **23** |
|***NF5.1 Excepcions, estructures d'emmagatzematge i fluxos d'informació*** | ***17*** | ***12*** |
|*A5.1.1 Control d'excepcions* | *5* | *3* | 
|*A5.1.2 Estructures d'emmagatzematge* | *12* | *9* | 
|*A5.1.3 Fluxos d'informació i XML* | *0* |  *0* | 
|NF5.2 **Interfícies gràfiques d'usuari** | **18** | ***11*** |
|*A5.2.1 Conceptes bàsics de GUI* | *9* | *5* |
|*A5.2.2 Conceptes avançats de GUI* | *9* | *6* |
